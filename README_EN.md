...
AnnaReader supports most mainstream e-book formats, so you don't have to worry about file conversion:
- **PDF**
- **EPUB**
- **MOBI** (Automatic conversion)
- **AZW3 / AZW**
- **TXT**
- **Markdown (MD)**

### 2. Deep Integration with Anna's Archive
...
- **Download**: Download books directly to your local shelf (via Slow Download).
...
- **macOS**
- **Linux**
- **Mobile Support** (Android/iOS in development)

### 4. Ultimate Security & Privacy
...
### 6. Comfortable Reading Experience
- **Customization**: Adjust font, size, background color, and line height.
- **Night Mode**: Protect your eyes during late-night reading.
- **Navigation**: Quick jump via table of contents.
